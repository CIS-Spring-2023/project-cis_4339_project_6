        ...
        <div class="card p-3 shadow p-3 mb-5 bg-body rounded">
              ...
              <div class="row">
                <div class="col-8 col-sm-8">
                  <label class="block mt-4">
                    <span class="text-gray-700">Service Name {{ updateData._id }}</span>
                    ...
                    <input
                      ...
                      v-model="updateData.name" type="text" />
                  </label>
                ...
                <div class="col-8 col-sm-8">
                  <label class="block mt-4">
                    ...
                    <textarea
                      ...
                      v-model="updateData.description" rows="2"></textarea>
                  </label>
                </div>
              </div>
            </div>
          ...
          <div class="row mt-5 text-center">
            <div class="col-12 mb-3">
              <button @click="updateService" type="submit" class="bg-green-700 text-white rounded mr-20 fw-bold"
                style="width: 100px">
                Save
              </button>
              <button @click="serviceDelete" type="submit" class="bg-red-700 text-white rounded mr-20 fw-bold"
                style="width: 100px">
                Delete
              </button>
              <button type="reset" class="border border-red-700 bg-white text-red-700 rounded fw-bold"
                style="width: 100px" @click="hideUpdateContainer(); showAddBtn()">
                Cancel
              </button>
            </div>
          </div>
