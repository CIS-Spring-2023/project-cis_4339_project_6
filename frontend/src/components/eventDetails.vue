...
export default {
  ...
  data() {
    return {
      servicesAll: [],  //array to hold all available event services
                    ...
                    <div class="card-body " style="overflow-y: auto; height:120px">
                      <ul>
                        <li v-for="serv in servicesAll" :key="serv._id">
                          <input type="checkbox" class="mr-2" v-model="event.services" :value="serv._id" />
                          <span>{{ serv.name }}</span>
                        </li>
                      </ul>
                    </div>
          ...
          <div class="col-sm-9">
            ...
            <div class="row mt-3">
              <div class="col-12  mb-3">
                <button @click="handleEventUpdate" type="submit" class="bg-green-700 text-white rounded mr-20 fw-bold"
                  style="width:100px">
                  Save
                </button>
                <button @click="eventDelete" type="submit" class="bg-red-700 text-white rounded mr-20 fw-bold"
                  style="width:100px">
                  Delete
                </button>
                <button type="reset" class="border border-red-700 bg-white text-red-700 rounded fw-bold"
                  style="width:100px" @click="$router.back()">
                  Back
                </button>
              </div>
            </div>
          ...
          <thead class="table-heading text-l"    style="position: sticky; top: 0">
              ...
              <tbody class="divide-y divide-gray-300">
                <tr @click="editClient(client._id)" v-for="client in clientAttendees" :key="client._id">
                  ...
                  <td class="p-3 pt-2 pb-2 text-left">{{ client.address.city }}</td>
                  <td class="p-3 pt-2 pb-2 text-left">
