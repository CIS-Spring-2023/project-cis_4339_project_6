...
<template>
  <main>
    <div>
      ...
      <div>
        <div class="ml-10">
          <h5 class="text-center text-red-700 font-bold mb-3">
            Attendee Count for Recent Events
          </h5>
        </div>
        <div class="flex flex-col col-span-2">
          <table class="min-w-full shadow-md rounded mb-4">
            <thead class="table-heading text-l text-left">
              <tr class="p-4 text-left">
                <th class="p-3 text-left">Event Name</th>
                <th class="p-3 text-left">Event Date</th>
                <th class="p-3 text-center">Attendee Count</th>
              </tr>
            </thead>
